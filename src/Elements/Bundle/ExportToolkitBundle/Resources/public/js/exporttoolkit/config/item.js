...
pimcore.plugin.exporttoolkit.config.Item = Class.create(pimcore.element.abstract, {
    ...
    checkExporterStatus: function(noTimeout) {
        ...
        Ext.Ajax.request({
            url: "/admin/elementsexporttoolkit/config/is-export-running",
            params: {
    ...
    startExport: function() {
        Ext.Ajax.request({
            url: "/admin/elementsexporttoolkit/config/execute-export",
            params: {
                name: this.data.general.name
            },
            success: function(response) {
            ...
            items: [{
                ...
                new Ext.form.ComboBox({
                    ...
                    store: new Ext.data.ArrayStore({
                        ...
                        proxy: {
                            type: 'ajax',
                            url: "/admin/elementsexporttoolkit/config/get-classes?type=export-filter"
                        },
                        fields: [
                            'classname'
                        ]
                ...
                new Ext.form.ComboBox({
                    ...
                    store: new Ext.data.ArrayStore({
                        ...
                        proxy: {
                            type: 'ajax',
                            url: "/admin/elementsexporttoolkit/config/get-classes?type=export-conditionmodificator"
                        },
                        fields: [
                            'classname'
                        ]
        ...
        var item =  new Ext.form.FormPanel({
            ...
            items: [{
                    ...
                    store: new Ext.data.ArrayStore({
                        ...
                        proxy: {
                            type: 'ajax',
                            url: "/admin/elementsexporttoolkit/config/get-classes?type=attribute-cluster-interpreter"
                        },
                        fields: [
                            'classname'
                        ]
    ...
    save: function () {
        ...
        Ext.Ajax.request({
            url: "/admin/elementsexporttoolkit/config/save",
            params: {
                data: saveData
            },
            method: "post",
